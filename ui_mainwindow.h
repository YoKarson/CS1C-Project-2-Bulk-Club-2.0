...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget->setGeometry(QRect(260, 240, 166, 25));
        ...
        layoutWidget1->setGeometry(QRect(230, 140, 211, 51));
        ...
        label->setGeometry(QRect(140, 10, 441, 81));
        QFont font;
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QCoreApplication::translate("MainWindow", "WELCOME TO BULK CLUB STAFF LOGIN!", nullptr));
    } // retranslateUi
